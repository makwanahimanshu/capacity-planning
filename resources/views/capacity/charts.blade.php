    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-header">
            ...
            <div class="header-right">
                <div class="filter-group">
                    ...
                    <input type="month" id="monthSelectForCharts" class="filter-control">

                    <input type="text" id="dateRangePicker" class="filter-control range-input"
        ...
        <div id="chartsSection">
            ...
            <div class="table-section">
                ...
                <!-- Search Box -->
                <div class="table-search mb-2">
                    <input type="text" id="projectWiseSearchInput" placeholder="Search projects..."
                        class="form-control">
                </div>
            ...
            <div class="table-section">
                ...
                <div class="table-search mb-2">
                    <input type="text" id="projectSummarySearchInput" placeholder="Search project summary..."
                        class="form-control">
                </div>
            ...
            <div class="table-section">
                ...
                <div class="table-search mb-2">
                    <input type="text" id="leaveReportSearchInput" placeholder="Search leave records..."
                        class="form-control">
                </div>
            ...
            <div class="table-section">
                ...
                <div class="table-search mb-2">
                    <input type="text" id="holidayReportSearchInput" placeholder="Search holiday records..."
                        class="form-control">
                </div>
